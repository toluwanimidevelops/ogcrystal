const Footer = () => {
  return (
    <>
      ...
      <div className="bg-[#071A3D]/20 pt-20 px-4">
        <footer className="bg-white w-full max-w-337.5 mx-auto text-black pt-8 lg:pt-12 px-4 sm:px-8 md:px-16 lg:px-28 rounded-tl-3xl rounded-tr-3xl overflow-hidden">
          ...
          <div className="relative">
            ...
            <h1 className="text-center font-extrabold leading-[0.7] text-transparent text-[clamp(2rem,8vw,6rem)] [-webkit-text-stroke:1px_#D4D4D4] mt-6">
              OGCRYSTAL
            </h1>
          </div>
        </footer>
